# Modified Version of https://codeberg.org/imbev/simplematrixbotlib
# License https://codeberg.org/imbev/simplematrixbotlib/src/branch/master/LICENSE
...
class Api:
    ...
    def __init__(self, creds: botlib.Creds, config: botlib.Config):
        """
    ...
    async def send_html_message(self, room_id: str, message: str, msgtype: str = "m.text"):
        await self._send_room(room_id=room_id,
                              content={
                                  "msgtype": msgtype,
                                  "format": "org.matrix.custom.html",
    ...
    async def delete_message(self, room_id: str, message_id: str):
        # TODO
        return
